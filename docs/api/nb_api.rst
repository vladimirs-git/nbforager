...
.. autoclass:: nbforager.api.connector.Connector
  :members:
    create,
    create_d,
    delete,
...
.. autoclass:: nbforager.api.ip_addresses.IpAddressesC.get
  :undoc-members:
...
.. _`Example of how to change loners`: https://github.com/vladimirs-git/nbforager/tree/main/examples/api/api__loners.py
