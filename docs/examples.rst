...
.. toctree::
   :caption: Contents:
    ...
    Root directory <https://github.com/vladimirs-git/nbforager/tree/main/examples>
    Create/delete bulk objects <https://github.com/vladimirs-git/nbforager/tree/main/examples/create_bulk>
